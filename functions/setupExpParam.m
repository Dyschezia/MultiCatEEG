...
% Response
Experiment.Time.RespWait = 4.0; % How long to allow for the response
Experiment.Time.FeedbackGap = 0.4; % Gap after feedback
Experiment.Time.CatchIti1 = 0.7;
%Experiment.Time.CatchIti2 = 1.0;

% ITI
Experiment.Time.ItiMean = 0.9; % Mean ITI in seconds
Experiment.Time.ItiRange = [0.8, 1]; % Range in which ITI varies
