...
for run = first_run:nRuns
    ...
    if run == 1
        instructions = ['Welcome. In this experiment you will view arrays made of one or four objects, which will appear for short durations.' ... 
            '\n Please try to identify the objects presented. After some trials you will be asked to decide whether' ...
            '\n a shown image had appeared in the preceding array.' ...
            '\n \n Moreover, please look at the fixation point in the middle of the screen throughout the experiment!' ...
