...
for run = first_run:nRuns
    ...
    if run == 1
        instructions = ['Welcome. In this experiment, single or multiple images will be presented on the screen for short duration.' ... 
            '\n Your task is to identify the objects presented. After some trials, you will be asked to decide (yes or no) whether' ...
            '\n an example image had appeared in the screen that just disappear. You will answer these questions with the ' ...
            '\n right and left buttons.' ... 
            '\n \n It is important that you do NOT move your eyes from the center of the screen, but look at the black dot in ' ... 
            '\n the middle of the screen throughout the experiment.Moreover, it is important that you do not blink when images ' ...
            '\n appear on the screen. You can move your eyes during a question if necassary, but bring them back to fixation ' ... 
            '\n before the next array appears. Try to blink only during questions or when only the central dot (and not images) ' ... 
            '\n is shown. You will be given times to rest your eyes throughout the experiment. ' ... 
